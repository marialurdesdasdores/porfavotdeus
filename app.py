...
if not UMBLER_API_KEY or not OPENAI_API_KEY or not UMBLER_ORG_ID:
    raise ValueError("Erro: Verifique se UMBLER_API_KEY, OPENAI_API_KEY e UMBLER_ORG_ID estão no .env")

# Configura chave da OpenAI
openai.api_key = OPENAI_API_KEY

# URL da Umbler para envio
